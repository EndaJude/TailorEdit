...
class MoLoAttnProcessor(nn.Module):
    r"""
    ...
    def __call__(
        ...
        if ip_hidden_states[0] is not None:
            # for ip-adapter
...
class MoLoAttnProcessor2_0(MoLoAttnProcessor):
    r"""
    ...
    def __call__(
        ...
        # 增加该模块以记录所有注意力图
        # attention_probs = attn.get_attention_scores(query, key, value)
